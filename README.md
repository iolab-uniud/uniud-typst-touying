...
```sh
# macOS
unzip uniud-touying-0.2.0-pacchetto-locale.zip \
  -d "$HOME/Library/Application Support/typst/packages/local"

typst init @local/uniud-touying:0.2.0 mia-lezione
...
the same everywhere. In any other document: `#import "@local/uniud-touying:0.2.0": *`.
